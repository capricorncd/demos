...
PIXI.WebGLRenderer.prototype.resize = function(width, height)
{
  ...
  {
    gl.deleteTexture( texture.renderTexture );
  }
  ...
  if(!this.renderBatch)this.renderBatch = PIXI._getBatch(gl);

  this.renderBatch.clean();
     this.pixiRenderTexture = new PIXI.BaseTexture();
