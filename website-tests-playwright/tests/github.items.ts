...
export const items = [
  ...
  },
  {
    ...
    tags: 'Tags: JavaScript/Vue.js/React.js/TypeScript/Scss/Webpack4',
    links: {
  ...
  },
  {
    ...
    links: {
      ...
      Source: 'https://github.com/capricorncd/demos/tree/main/three'
    }
  },
  {
    title: 'School Circle Web Site',
    url: 'https://capricorncd.github.io/demos/app-website/',
    desc: `Listen,it's like falling in love`,
    tags: 'Tags: Nuxt.js(Vue.js)/Sass/CSS3(animation)/HTML5',
    links: {
      Demo: 'https://capricorncd.github.io/demos/app-website/',
      Source: 'https://github.com/capricorncd/demos/tree/main/app-website'
    }
  },
  {
    title: 'Web Audio',
    url: 'https://capricorncd.github.io/demos/web-audio/',
    desc: 'Use AudioContext to achieve cool music playback effects  in the browser',
    tags: 'Tags: JavaScript/AudioContext/Canvas/Scss/Webpack5',
    links: {
      Demo: 'https://capricorncd.github.io/demos/web-audio/',
      Source: 'https://github.com/capricorncd/demos/tree/main/web-audio'
    }
  }
]