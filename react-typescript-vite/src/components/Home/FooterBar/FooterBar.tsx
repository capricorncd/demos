...
type FooterBarProps = DefaultProps
...
export default function FooterBar(props: FooterBarProps) {
  ...
  return (
    <>
      ...
      />
      <SideBar data={props.data} visible={sideBarVisible} onClose={() => setSideBarVisible(false)} />
      <DetailPopup foodId={selectedItemId} visible={detailVisible} onClose={() => setDetailVisible(false)} />
    </>
  )
}
